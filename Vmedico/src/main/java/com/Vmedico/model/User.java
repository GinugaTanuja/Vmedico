...
public class User {
	...
	// constructor
	/*
	 * public User(String pusername, int page, String pgender, String pbloodgroup,
	 * String paddress, String pemail, String pcontactno, String ppassword) {
	 * super(); this.pusername = pusername; this.page = page; this.pgender =
	 * pgender; this.pbloodgroup = pbloodgroup; this.paddress = paddress;
	 * this.pemail = pemail; this.pcontactno = pcontactno; this.ppassword =
	 * ppassword; }
	 */
