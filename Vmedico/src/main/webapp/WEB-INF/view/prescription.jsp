...
<body>
	...
	<div class="container">
		<c:choose>
			<c:when test="${mode=='MODE_SHOWPRESCRIPTION' }">
				<div class="container text-center" id="taskDiv">
					...
					<div class="table-responsive text-align-center">
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<c:forEach var="prescriptionAndAppointment"
									items="${prescriptionAndAppointments}">
									<tr>
										<td><c:out
												value="${prescriptionAndAppointment.prescriptionid}" /></td>
										<td><c:out
												value="${prescriptionAndAppointment.patientusername}" /></td>
										<td><c:out
												value="${prescriptionAndAppointment.doctorusername}" /></td>
										<td><c:out
												value="${prescriptionAndAppointment.patientprescription}" /></td>
